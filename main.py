...
from TreeRGNet import Tree_RG_Net
...
parser.add_argument('--input_nc', dest='input_nc', type=int, default=1, help='# of input image channels (edge images)')
parser.add_argument('--output_nc', dest='output_nc', type=int, default=2, help='# of output image channels (RG silhouette)')
...
def main(_):
    ...
    with tf.Session() as sess:
        model = Tree_RG_Net(sess, image_size=args.fine_size, batch_size=args.batch_size,
